...
<body>
    <div class="py-10 px-10 h-screen lg:max-w-6xl lg:mx-auto">
        <h1 class="text-xl mb-2">Ansatte</h1>

        <div class="overflow-auto rounded-lg border border-gray-200 hidden md:block bg-gray-50 mb-20">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 ">
                <thead class="text-sm text-gray-700 uppercase bg-gray-100">
                    <tr>
                        <th scope="col" class="px-4 py-3">Avdeling</th>
                        <th scope="col" class="px-4 py-3">E-post</th>
                ...
                <tbody>
                    <tr class="border-b dark:border-gray-700">
                        <td class="px-4 py-3">Helse- og oppvekstfag</td>
                        <td class="px-4 py-3 max-w-[12rem] truncate">eksempel@mail.no</td>
                        <td class="px-4 py-3 flex items-center justify-end">
                            <button id="dropdown-1-button" data-dropdown-toggle="dropdown-1" class="inline-flex items-center text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 p-1.5 dark:hover-bg-gray-800 text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                    ...
                    <tr class="dark:border-gray-700">
                        <td class="px-4 py-3">Informatikklinja</td>
                        <td class="px-4 py-3 max-w-[12rem] truncate">eksempel@mail.no</td>
                        <td class="px-4 py-3 flex items-center justify-end">
                            ...
                            <div id="playstation-5-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 border border-gray-200 dark:bg-gray-700 dark:divide-gray-600">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 md:hidden">
                    <div class="bg-white space-y-3 rounded-lg bg-gray-50 border border-gray-200 relative">
                        <div class="flex items-center text-sm p-4 rounded-t-lg bg-gray-100">
                            <div class="text-gray-500">Helse- og oppvekstfag</div>
                            <div class="absolute top-4 right-4"> <!-- Justert plassering av knappen -->
                ...
                <div class="px-5 pb-4 text-sm text-gray-700">
                    eksempel@mail.no
                </div>
            </div>
        </div>
